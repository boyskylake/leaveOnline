...
<body>
  ...
  <div class="container-fluid">
    ...
    <div class="navbar-header">
      ...
      <a class="navbar-brand" href="index_admin.php"><i class="fa fa-fw fa-home"></i>Brand</a>
    </div>

    <!-- Collect the nav links, forms, and other content for toggling -->
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li><a href="add_admin.php"><i class="fa fa-fw fa-user"></i>สมาชิก<span class="sr-only">(current)</span></a></li>
        <li><a href="affiliation.php">สังกัด</a></li>
