...
<?php
	...
	if (empty($id) or empty($name) or empty($position) or empty($degree) or empty($affiliation) or empty($leavecollect) or empty($leaveleft) or empty($leaveall) or empty($status) or empty($image) or empty($password) or empty($conpassword)) {
	?>
